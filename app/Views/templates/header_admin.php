                ...
                <ul class="navbar-nav mr-auto px-2">
                    ...
                    <li class="nav-item dropdown px-2">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <?php echo anchor("admin/lezioni/elencolezioni", "Elenco lezioni", "class='dropdown-item px-2'"); ?>
                            <div class="dropdown-divider"></div>
                            <?php echo anchor("admin/lezioni/nuovalezione", "Inserisci lezione", "class='dropdown-item px-2'"); ?> 
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown px-2">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <?php echo anchor("admin/istruttori/elencoistruttori", "Elenco istruttori", "class='dropdown-item px-2'"); ?>
                            <div class="dropdown-divider"></div>
